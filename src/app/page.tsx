    ...
    <main className="min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#0d0d2b] to-[#0a0a0a] text-white">
      ...
      <footer className="border-t border-white/[0.06] py-10 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <span className="font-bold text-lg">✨ From Hhh (hh@gmail.com) 00:00</span>
          <div className="flex gap-8 text-sm text-gray-500">
            <a href="#features" className="hover:text-purple-400 transition-colors">Features</a>
            <a href="#pricing" className="hover:text-purple-400 transition-colors">Pricing</a>
            <a href="#reviews" className="hover:text-purple-400 transition-colors">Reviews</a>
          </div>
          <p className="text-gray-600 text-sm">© 2025 From Hhh (hh@gmail.com) 00:00. Built with <span className="text-purple-400">Heaven AI</span></p>
        </div>
      </footer>
    </main>
  );
